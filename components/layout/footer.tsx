  ...
  return (
    <footer className="w-full bg-[#0a0a0b] text-[#f4f4f6] pt-16 sm:pt-24 pb-10 px-6 sm:px-12 lg:px-16 border-t border-zinc-900/80 select-none relative overflow-hidden">
      <div className="max-w-[1600px] mx-auto space-y-16 sm:space-y-20">
        ...
        <div className="pt-8 pb-4 flex items-center justify-center border-t border-zinc-900/80 overflow-hidden">
          <p
            aria-hidden="true"
            className="whitespace-nowrap text-[9.5vw] 2xl:text-[14rem] font-sans font-black tracking-tighter text-zinc-400 hover:text-primary transition-colors duration-500 text-center leading-none uppercase select-none w-full"
          >
            MOLINA RANA
          </p>
        </div>
